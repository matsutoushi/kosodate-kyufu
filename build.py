...
def build_shindan(data):
    ...
    checks = [
        ...
        ("company", "会社員・公務員で産休・育休を取る(取った)", ["shussan-teate", "ikuji-kyugyo-kyufu", "shaho-menjo"]),
        ("jieigyo", "自営業・フリーランス・個人事業主である(国民年金の第1号)", ["kokunen-menjo"]),
        ("taishoku", "妊娠・出産・育児で仕事を辞めた(辞める予定)", ["koyo-encho"]),
