...
COVERS = {
    ...
    "hoiku-encho":      ("🏫", "保育園に落ちたのに", "育休を延ばせない人がいます", "2025年4月から確認が変わりました"),
    "jitan-kyufu":      ("⏱️", "時短勤務にも", "給付金があります", "2025年4月に始まった制度です"),
    "shaho-getsumatsu": ("📅", "育休の保険料免除は", "「月末」で決まります", "同じ2週間でも結果が違います"),
    "shussan-2tsu":     ("👶", "扶養に入っていると", "出産手当金はもらえません", "一時金と手当金は別ものです"),
}
...
STORY["hoiku-encho"] = {
    "emoji": "\U0001F3EB",
    "hook": "保育園に落ちたのに\n育休を延ばせない人がいます", "hook_size": 70,
    "cta": ("保育園に申し込む人に送ってください", "保存 して送る"),
    "scenes": [
        {"type": "bars", "title": "2025年4月から変わりました", "rows": [
            ("これまで", "入所保留通知があれば延長できた"),
            ("いまは", "申込書の写しも出して確認されます"),
            ("見られるのは", "職場に戻るための申し込みだったか"),
        ]},
        {"type": "bars", "title": "延長が認められない例", "rows": [
            ("自宅から片道30分以上の園だけ", "合理的な理由がない場合"),
            ("申込書で入所保留を希望した", "「入所を希望しない」なども同じ"),
            ("内定が出たのに辞退した", "住所や勤務先が変わった場合などを除く"),
        ]},
        {"type": "big", "title": "申し込む前にやること",
         "big": "写しを取る", "big_size": 110,
         "sub": "申込書の全ページ・電子申請は画面を印刷",
         "note": "延長の手続きで必ず提出します"},
        {"type": "bars", "title": "日付も確認されます", "rows": [
            ("申込日", "1歳の誕生日の前日までに"),
            ("入所希望日", "原則 1歳の誕生日以前の日"),
            ("保留通知の発行日", "誕生日の2か月前以後(4月入所は3か月前)"),
        ]},
        {"type": "bars", "title": "30分以上でも認められる場合", "rows": [
            ("通勤経路の途中にある園", "勤務先から30分未満の園も含みます"),
            ("30分未満で通える園がない", "開所時間が勤務に合わない場合も"),
        ]},
    ],
}
...
STORY["jitan-kyufu"] = {
    "emoji": "\u23F1\uFE0F",
    "hook": "時短勤務にも\n給付金があります",
    "cta": ("時短で復帰する人に送ってください", "保存 して送る"),
    "scenes": [
        {"type": "bars", "title": "2025年4月に始まりました", "rows": [
            ("名前は", "育児時短就業給付金"),
            ("対象は", "2歳未満の子のために時短で働く人"),
            ("出るのは", "時短中に支払われた賃金の 10%"),
        ]},
        {"type": "count", "title": "たとえば、こんな人", "rows": [
            ("時短を始めたときの賃金", "月 30万円"),
            ("時短後に支払われた賃金", "月 20万円"),
            ("支給率", "10%"),
        ], "lead": "毎月の給付は", "value": 20000},
        {"type": "big", "title": "いつまでもらえるか",
         "big": "2 歳", "big_size": 150,
         "sub": "2歳の誕生日の前々日の月まで",
         "note": "時短勤務は3歳まで、給付は2歳まで"},
        {"type": "bars", "title": "0円になる月があります", "rows": [
            ("賃金が時短前から下がっていない", "昇給や残業代で100%以上になった月"),
            ("週20時間を下回った", "原則、雇用保険から外れて対象外"),
        ]},
        {"type": "bars", "title": "やることは会社に頼むだけ", "rows": [
            ("申請は原則、会社から", "ハローワークに2か月ごとに申請"),
            ("期限は4か月以内", "支給対象月の初日から数えます"),
        ]},
    ],
}

STORY["shaho-getsumatsu"] = {
    "emoji": "\U0001F4C5",
    "hook": "育休の保険料免除は\n「月末」で決まります",
    "cta": ("育休の日程を決める人に送ってください", "保存 して送る"),
    "scenes": [
        {"type": "bars", "title": "ルールは2つだけ", "rows": [
            ("月末に育休中の月", "その月の保険料が免除されます"),
            ("同じ月の中で14日以上", "始めた月と終わった翌日の月が同じとき"),
        ]},
        {"type": "bars", "title": "同じ2週間でも結果が違います", "rows": [
            ("10月10日〜10月23日", "10月分は免除(14日ルール)"),
            ("10月25日〜11月7日", "10月分は免除 / 11月分は免除なし"),
            ("10月10日〜10月20日", "11日なので免除されません"),
        ]},
        {"type": "big", "title": "月をまたいだ後ろの月は",
         "big": "14日ルール対象外", "big_size": 72,
         "sub": "後ろの月は月末まで休む必要があります",
         "note": "11月に20日休んでも11月分は対象外"},
        {"type": "bars", "title": "賞与の保険料は別の条件", "rows": [
            ("賞与月の末日を含んで", "連続1か月を超える育休が必要"),
            ("土日も含めて暦日で数えます", "2週間の育休では賞与分は免除されません"),
        ]},
        {"type": "bars", "title": "知っておくと効く2つ", "rows": [
            ("産後パパ育休中に働く日", "14日を数えるときは除きます"),
            ("手続きは会社が行います", "免除でも将来の年金は減りません"),
        ]},
    ],
}
...
STORY["shussan-2tsu"] = {
    "emoji": "\U0001F476",
    "hook": "扶養に入っていると\n出産手当金はもらえません",
    "cta": ("妊娠中の友だちに送ってください", "保存 して送る"),
    "scenes": [
        {"type": "bars", "title": "名前は似ていますが別ものです", "rows": [
            ("出産育児一時金", "出産費用の補助。子ども1人50万円"),
            ("出産手当金", "産休で給与が出ない間の収入の補償"),
        ]},
        {"type": "bars", "title": "あなたはどれ?", "rows": [
            ("会社員で産休を取る", "一時金も手当金も もらえます"),
            ("夫の扶養に入っている", "一時金だけ(家族出産育児一時金)"),
            ("自営業など国民健康保険", "一時金はもらえる・手当金は保険による"),
        ]},
        {"type": "big", "title": "出産手当金が出る期間",
         "big": "最大 98 日", "big_size": 110,
         "sub": "産前42日＋産後56日(1人の場合)",
         "note": "日額のおよそ3分の2×休んだ日数"},
        {"type": "bars", "title": "つまずきやすい2つ", "rows": [
            ("パートでも扶養のままなら対象外", "自分の保険証を確認してください"),
            ("出産費用が50万円より安かった", "差額は自分で請求できます"),
        ]},
        {"type": "bars", "title": "育休に入ると別の制度に", "rows": [
            ("産休中", "出産手当金(健康保険から)"),
            ("育休中", "育児休業給付金(雇用保険から)"),
        ]},
    ],
...
CAPTION_HOIKU_ENCHO = """【保育園に落ちたのに、育休を延ばせない人がいます】

4月入所の申し込みが始まる時期なので、申し込む前に読んでください。

保育所に入れなかったとき、育児休業給付金は1歳6か月、さらに2歳まで延ばせます。
変わったのは確認の中身です。

▶ これまで:入所保留通知があれば延長できた
▶ 2025年4月から:申込書の写しも提出し、「すぐ職場に戻るための申し込みだったか」を確認される

入所保留通知が出ていても、こんな場合は認められません。
・自宅から片道30分以上かかる園だけに申し込んだ(合理的な理由がない場合)
・申込書で入所保留を希望した
・内定が出たのに辞退した(住所や勤務先が変わった場合などを除く)
...
・申込日は1歳の誕生日の前日まで
・入所希望日は原則1歳の誕生日以前
・保留通知の発行日は、誕生日の2か月前(4月入所は3か月前)以後

30分以上の園でも、通勤経路の途中にある、30分未満で通える園が無い、開所時間が勤務に合わない、などの理由があれば認められます。

申込書は出す前に必ず写しを取ってください。電子申請なら画面を印刷して保管を。
これから保育園に申し込む人に送ってあげてください📌

※出典:厚生労働省・ハローワーク。個別の判断はハローワークにご確認ください。

#保育園 #保活 #育休延長 #育児休業給付金 #入所保留 #保育園落ちた #育休 #育休中 #ワーママ #子育て #育児 #ママ #0歳 #1歳 #知らないと損
"""

CAPTION_JITAN_KYUFU = """【時短勤務にも給付金があります】

2025年4月に始まった「育児時短就業給付金」。
まだ知らない人がとても多い制度です。

▶ 対象:2歳未満の子のために、勤務時間を短くして働く人(雇用保険に入っている人)
▶ 金額:時短中の各月に支払われた賃金の10%
▶ 期間:2歳の誕生日の前々日の月まで

たとえば時短前の賃金が月30万円、時短後に支払われた賃金が月20万円なら、毎月20,000円です。

1日6時間の時短に限りません。
勤務日数を減らした場合や、子育てのためにパートに変わった場合も対象です。

0円になる月もあります。
・賃金が時短前から下がっていない月(昇給や残業代で100%以上になった月)
・週の所定労働時間が20時間を下回った場合(原則、雇用保険から外れます)

申請は原則として会社がハローワークに行います。期限は支給対象月の初日から4か月以内。
新しい制度なので、復帰前に会社へ「時短給付の手続きをお願いします」と伝えておくのが確実です。

時短で復帰する人に送ってあげてください📌

※支給率は賃金が時短前の90%を超えると下がります。支給限度額などは毎年8月に改定されます。出典:厚生労働省。

#時短勤務 #育児時短就業給付金 #育休復帰 #職場復帰 #ワーママ #共働き #育休明け #子育て #育児 #ママ #雇用保険 #給付金 #家計管理 #お金の勉強 #知らないと損
"""

CAPTION_SHAHO_GETSUMATSU = """【育休の保険料免除は「月末」で決まります】

育休中は健康保険料と厚生年金保険料が免除されます。
でも、何日休んだかではなく、いつからいつまで休んだかで結果が変わります。

ルールは2つ。
▶ 月末に育休中の月は免除
▶ 始めた月と終わった翌日の月が同じなら、その月に14日以上で免除

同じ2週間でも、
・10月10日〜23日 → 10月分は免除(14日ルール)
・10月25日〜11月7日 → 10月分は免除、11月分は免除なし
・10月10日〜20日(11日) → 免除されない

いちばん誤解が多いのは、月をまたいだ育休。
後ろの月は、14日以上休んでも14日ルールが使えません。月末まで休む必要があります。

賞与の保険料はさらに厳しく、賞与月の末日を含む連続1か月を超える育休が必要です。

産後パパ育休中に働く日を入れると、14日を数えるときにその日は除かれます。
手続きは会社が行い、免除されても将来の年金は減りません。

育休の日程を決める前に、パートナーにも送ってください📌

※2022年10月以降に始めた育休の扱いです。出典:日本年金機構。

#育休 #産後パパ育休 #男性育休 #パパ育休 #社会保険料 #社会保険料免除 #育休中 #共働き #子育て #育児 #プレパパ #プレママ #家計管理 #お金の勉強 #知らないと損
"""

CAPTION_SHUSSAN_2TSU = """【扶養に入っていると、出産手当金はもらえません】

名前は似ていますが、まったく別の制度です。

▶ 出産育児一時金:出産費用の補助。子ども1人50万円
▶ 出産手当金:産休で給与が出ない間の収入の補償

もらえるかどうかは、入っている健康保険で決まります。
・会社員で産休を取る → 両方もらえる
・夫の扶養に入っている → 一時金だけ(家族出産育児一時金として50万円)
・自営業など国民健康保険 → 一時金はもらえる。手当金は保険による

出産手当金は、産前42日＋産後56日の最大98日(1人の場合)。
金額は標準報酬日額のおよそ3分の2×休んだ日数です。

つまずきやすいのはこの2つ。
・パートで働いていても、夫の扶養のままなら手当金は出ません
・出産費用が50万円より安かったら、差額は自分で請求できます

育休に入ったら、今度は育児休業給付金(雇用保険)に切り替わります。

「2つとももらえるはず」で家計を組む前に、妊娠中の友だちにも送ってあげてください📌

※出典:協会けんぽ。金額や扱いは加入している健康保険でご確認ください。

#出産育児一時金 #出産手当金 #妊娠 #妊娠初期 #妊娠中期 #プレママ #出産準備 #扶養 #産休 #子育て #育児 #ママ #家計管理 #お金の勉強 #知らないと損
"""
...
REELS = [
    ...
    ("furusato",        "coral",    render_furusato,   CAPTION_FURUSATO,  "投稿済み"),
    ("shotoku-seigen",  "navy",     render_shotokuseigen, CAPTION_SEIGEN, "投稿済み"),
    ("fuyo-kojo",       "lavender", render_fuyokojo,   CAPTION_FUYO,      "投稿済み"),
    ("hitorioya",       "peach",    render_hitorioya,  CAPTION_HITORIOYA, "投稿済み"),
    ("kogaku-2026",     "navy",     render_kogaku2026,   CAPTION_KOGAKU2026,   "投稿済み"),
    ("koko-furikomi",   "peach",    render_kokofurikomi, CAPTION_KOKOFURIKOMI, "投稿済み"),
    ("jido-shikyubi",   "mint",     render_jidoshikyubi, CAPTION_JIDOSHIKYUBI, "投稿済み"),
    ("matome-8",        "lavender", render_matome,       CAPTION_MATOME,       "投稿済み"),
    ("kabe-hayami",     "coral",    hayami("kabe-hayami"),    CAPTION_KABE2,     "投稿済み"),
    ("shussan-hayami",  "coral",    hayami("shussan-hayami"), CAPTION_SHUSSAN_H, "投稿済み"),
    ("gakuhi-hayami",   "coral",    hayami("gakuhi-hayami"),  CAPTION_GAKUHI_H,  "投稿済み"),
    ("kigen-hayami",    "coral",    hayami("kigen-hayami"),   CAPTION_KIGEN_H,   "投稿済み"),
    ("nenkin-ikuji",    "mint",     story("nenkin-ikuji"),   CAPTION_NENKIN_IKUJI,   "投稿済み"),
    ("kogaku-2nen",     "coral",    story("kogaku-2nen"),    CAPTION_KOGAKU_2NEN,    "投稿済み"),
    ("shitsugyo-4nen",  "lavender", story("shitsugyo-4nen"), CAPTION_SHITSUGYO_4NEN, "投稿済み"),
    ("iryohi-5nen",     "navy",     story("iryohi-5nen"),    CAPTION_IRYOHI_5NEN,    "投稿済み"),
    ("hoiku-encho",      "peach",    story("hoiku-encho"),      CAPTION_HOIKU_ENCHO,      "未投稿"),
    ("jitan-kyufu",      "mint",     story("jitan-kyufu"),      CAPTION_JITAN_KYUFU,      "未投稿"),
    ("shaho-getsumatsu", "navy",     story("shaho-getsumatsu"), CAPTION_SHAHO_GETSUMATSU, "未投稿"),
    ("shussan-2tsu",     "coral",    story("shussan-2tsu"),     CAPTION_SHUSSAN_2TSU,     "未投稿"),
]
...
def write_index():
    ...
    NOTE = {
        ...
        "hoiku-encho": "保育園に落ちても育休を延ばせない例",
        "jitan-kyufu": "時短勤務の給付金(賃金の10%)",
        "shaho-getsumatsu": "育休の保険料免除は月末で決まる",
        "shussan-2tsu": "扶養だと出産手当金は出ない",
    }
